export const initialData = {
    ...
    skills: ['Javascript', 'NodeJs', 'Java', 'SpringBoot', 'Css', 'HTML', 'MongoDB', 'MySQL', 'Kubernates', 'Scrum', 'Jira', 'Git', 'RESTful API', 'ReactJS', 'Material-UI', 'Redux'],
    projects: [
        {
            id: 1,
...
export const parsedMockData = {
    personal: {
        ...
        summary: "Results-oriented Product Manager with 6 years of experience in agile environments. Skilled in roadmapping, user research, and data analytics. Successfully launched 3 major SaaS products.",
        socials: [
