...
const JobAssistantModal = ({ isOpen, onClose, resume, onImproveResume }) => {
    ...
    const handleTailor = async () => {
        ...
        if (
            !window.confirm(
                'This will overwrite your current resume content with a tailored version. You can Undo this. Continue?'
            )
        )
            return;
                ...
                <div className="flex-1 overflow-hidden flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-1/3 p-6 border-r border-gray-100 bg-gray-50 flex flex-col gap-4 overflow-y-auto">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            >
                                {isLoading && activeTab === 'coverLetter' ? (
                                    <Loader className="animate-spin" />
                                ) : (
                                    <FileText size={18} />
                                )}
                                    ...
                                    <div className="bg-red-50 rounded-xl p-5 border border-red-100">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {matchResult.missingKeywords.map((kw, i) => (
                                                <span
                                                    key={i}
                                                    className="px-3 py-1 bg-white text-red-600 rounded-full text-sm font-medium border border-red-200 shadow-sm"
                                                >
                                                    {kw}
                                                </span>
                                            ))}
