...
const LayoutGold = ({ data, pageIndex, isMeasurement }) => {
    ...
    return (
        ...
        >
            {/* Decorative Frame */}
            <div
                className="absolute inset-4 border-2 border-double"
                style={{ borderColor: goldColor, opacity: 0.3, pointerEvents: 'none' }}
            ></div>
            ...
            <div className={`px-20 py-10 flex flex-col ${isMeasurement ? '' : 'h-full'}`}>
                ...
                {(!pageIndex || pageIndex === 0) && (
                    <header id="section-personal" className="text-center mb-12 relative">
                        ...
                        <h1
                            className="text-5xl font-bold mb-4 tracking-wide uppercase"
                        ...
                        <div className="flex items-center justify-center gap-4 mb-6">
                            ...
                            <p
                                className="text-xl font-medium italic tracking-wider"
                ...
                <div className="flex-1 flex flex-col gap-10">
                    {data.sectionOrder?.map((sectionId) => {
                        const isCustom = !['summary', 'experience', 'education', 'skills'].includes(
                            sectionId
                        );
                            ...
                            return (
                                ...
                                >
                                    <p className="text-slate-700 leading-loose text-justify font-light text-sm">
                                        <span
                                            className="text-4xl float-left mr-2 -mt-2"
                                            style={{
                                                color: goldColor,
                                ...
                                >
                                    ...
                                    <div className="space-y-8">
                                        {experience.map((exp) => (
                                            ...
                                            >
                                                <div
                                                    className="absolute -left-[9px] top-1.5 w-4 h-4 bg-white border-2 rounded-full"
                                                    style={{ borderColor: goldColor }}
                                                ></div>
                                                ...
                                                <div className="flex justify-between items-baseline mb-2">
                                                    ...
                                                    <span
                                                        className="text-xs font-bold uppercase tracking-wider px-2 py-1 bg-white border rounded"
                                    ...
                                    <div className="grid grid-cols-1 gap-6">
                                        {education.map((edu) => (
                                            <div
                                                key={edu.id}
                                                id={`item-${edu.id}`}
                                                className="flex justify-between items-center p-4 bg-white border border-stone-100 shadow-sm break-inside-avoid"
                                            >
                                                <div>
                                                    <h4
                                                    ...
                                                    <div className="text-slate-600 italic text-sm mt-1">
                                                        {edu.degree}
                                                    </div>
                                                </div>
                                                <span
                                ...
                                >
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {skills.map((skill, index) => (
                                            <div
                                                key={index}
                                                className="px-4 py-2 bg-white border text-sm font-medium tracking-wide shadow-sm"
                                    ...
                                    <div className="space-y-6">
                                        {customSection.items.map((item) => (
                                            ...
                                            >
                                                ...
                                                {item.description && (
                                                    <p className="text-slate-700 text-sm leading-relaxed whitespace-pre-line font-light">
                                                        {item.description}
                                                    </p>
                                                )}
                                            </div>
