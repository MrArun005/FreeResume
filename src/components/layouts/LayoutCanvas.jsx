    ...
    return (
        ...
        >
            ...
            <DraggableElement
                ...
                initialSize={{
                    w: getStyle('name', 50, 50, 'auto', 'auto').w,
                    h: getStyle('name', 50, 50, 'auto', 'auto').h,
                }}
            ...
            <DraggableElement
                ...
                initialSize={{
                    w: getStyle('title', 50, 110, 'auto', 'auto').w,
                    h: getStyle('title', 50, 110, 'auto', 'auto').h,
                }}
                onUpdate={handleUpdate}
            >
            ...
            <DraggableElement
                ...
                initialSize={{
                    w: getStyle('contact', 50, 160, 'auto', 'auto').w,
                    h: getStyle('contact', 50, 160, 'auto', 'auto').h,
                }}
                onUpdate={handleUpdate}
            >
            ...
            <DraggableElement
                ...
                initialSize={{
                    w: getStyle('summary', 50, 250, 500, 'auto').w,
                    h: getStyle('summary', 50, 250, 500, 'auto').h,
                }}
                onUpdate={handleUpdate}
            >
            ...
            <DraggableElement
                ...
                initialSize={{
                    w: getStyle('experience', 50, 400, 500, 'auto').w,
                    h: getStyle('experience', 50, 400, 500, 'auto').h,
                }}
                onUpdate={handleUpdate}
            >
                <div className="w-full h-full">
            ...
            <DraggableElement
                ...
                initialSize={{
                    w: getStyle('education', 600, 50, 250, 'auto').w,
                    h: getStyle('education', 600, 50, 250, 'auto').h,
                }}
                onUpdate={handleUpdate}
            >
                <div className="w-full h-full">
            ...
            <DraggableElement
                ...
                initialSize={{
                    w: getStyle('skills', 600, 300, 250, 'auto').w,
                    h: getStyle('skills', 600, 300, 250, 'auto').h,
                }}
                onUpdate={handleUpdate}
            >
                <div className="w-full h-full">
