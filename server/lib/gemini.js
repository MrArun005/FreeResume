...
// `schema` constrains output to JSON via responseSchema.
export async function generateWithFallback(prompt, schema = null) {
...
// chain. Used by the resume-parse endpoint for native PDF input.
export async function generateFromParts(parts, schema = null) {
    if (!genAI) throw new Error('Gemini not initialized — call initGemini(apiKey) first');
